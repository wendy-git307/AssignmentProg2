...
public void handleRemove(ActionEvent event) throws IOException  {
    ...
    if (currentSelectedTable!= null) {
        ...
        if (selectedAnimal!=null) {
            ...
            all.remove(selectedAnimal);
            // remove from each filtered table also
            if (selectedAnimal instanceof Cat) {
                cats.remove(selectedAnimal);
            } else if (selectedAnimal instanceof Dog) {
                dogs.remove(selectedAnimal);
            } else if (selectedAnimal instanceof Rabbit) {
                rabbits.remove(selectedAnimal);
            }
